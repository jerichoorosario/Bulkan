...
public class AfterFragment extends Fragment {
    ...
    public static AfterFragment newInstance(int position) {
        AfterFragment f = new AfterFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        llOnboarding.setBackground(getActivity().getResources().getDrawable(R.drawable.onboard_after));
